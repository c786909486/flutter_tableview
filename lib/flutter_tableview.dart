      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        if(model!=null){
          if (model.row == 0 && model.haveHeaderWidget==true) {
            ...
            int? row = model.haveHeaderWidget == false ? model.row : (model.row??0) - 1;
            itemWidget = this.widget.cellBuilder(context, model.section??0, row??0);
            height = this.widget.cellHeight(context, model.section??0, row??0);
          }
